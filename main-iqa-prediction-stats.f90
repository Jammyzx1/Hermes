...
!****************************************************************************
!
! Originally created by Stuart with modification by James.
! Version 1.1
! CHANGE LOG 
! Version 1  : To calculate statistics from krigining multipoles. 
! Version 1.1: Modular format and incorporation in the Hermes program and set up for iqa kriging.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    module krigingcoefficientiqa

      implicit none

    contains

      subroutine krigcoefficentiqa
    integer i,j,NoPreds,linecount,ios,ios2,ios3,nprops,propcount
    character*100 Title,dummychar,dum,dum2,atomname,filename,outnames(2),curprop
...
57  continue   
    ...
    outnames(1)='./'//trim(title)//'_kriging_'//trim(atomname)//'_q22c_PREDICTIONS.txt'
    outnames(2)='./'//trim(title)//'_kriging_'//trim(atomname)//'_q22s_PREDICTIONS.txt'
    ...
    do propcount=1,nprops
       ...
       do j=1,NoPreds
          ...
          close(unit=1)
       enddo
    end subroutine krigcoefficentiqa
  end module krigingcoefficientiqa
